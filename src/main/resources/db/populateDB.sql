...
INSERT INTO menu (name, price, menu_date, restaurant_id) VALUES
       ...
       ('Хот дог', 2.0, '2019-12-17', 100001),
       ('Картофель фри', 3.45, '2019-12-17', 100001),
       ('Чизбурер', 5.21, '2019-12-18', 100001),
       ('Воппер', 2.67, '2019-12-18', 100001),
       ('Паста', 10.60, '2019-12-16',  100000),
       ('Сибас', 16.63, '2019-12-16', 100000),
       ('Суп-пюре', 7.35, '2019-12-17', 100000),
       ('Паста карбонара', 15.39, '2019-12-17', 100000),
       ('Пицца', 16.23, '2019-12-18', 100000),
       ('Брускетта с помидорами', 7.35, '2019-12-18', 100000);
