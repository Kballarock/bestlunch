...
<head>
    ...
    <link rel="shortcut icon" href="${pageContext.request.contextPath}/resources/image/fried-potatoes.png">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/style.css">

    <script type="text/javascript" src="webjars/jquery/3.4.1/jquery.min.js"></script>
    <script type="text/javascript" src="webjars/bootstrap/4.4.0/dist/js/bootstrap.min.js"></script>
