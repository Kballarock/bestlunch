...
public class UserTestData {
    ...
    public static final User ADMIN = new User(100000, "Admin", "admin@admin.com", "admin", true, of(2019, 12, 16), Collections.singleton(Role.ROLE_ADMIN));
    public static final User USER = new User(100001, "User", "user@user.com", "user", true, of(2019, 12, 16), Collections.singleton(Role.ROLE_USER));
